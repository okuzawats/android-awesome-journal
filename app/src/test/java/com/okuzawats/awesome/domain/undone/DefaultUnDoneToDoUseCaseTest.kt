...
class DefaultUnDoneToDoUseCaseTest {
  companion object {
    const val ID_UN_DONE_TO_DO_SUCCESS = "1"
    const val ID_UN_DONE_TO_DO_FAILURE = "2"
  }
  ...
  @Test
  fun emitsToDoOnlyIfSavedSuccessfully() = runTest {
  ...
  @Test
  fun emitsDoneAfterEmittingToDoIfSaveFailed() = runTest {
